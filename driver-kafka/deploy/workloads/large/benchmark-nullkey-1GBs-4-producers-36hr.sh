...
# Step 1
cat > workloads/benchmark-nullkey-1GBs-4-producers-36hr-step1.yaml << EOF
name: benchmark-nullkey-1GBs-4-producers-36hr-step1__AK-1000MBs
...
workloads/benchmark-nullkey-1GBs-4-producers-36hr-step1.yaml
