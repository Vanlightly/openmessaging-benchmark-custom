...
cat > workloads/benchmark-redpanda-backlog-drain-800MB-1.6TB-backlog-fanout3-step1.yaml << EOF
name: benchmark-redpanda-backlog-drain-800MB-1.6TB-backlog-fanout3-step1
...
workloads/benchmark-redpanda-backlog-drain-800MB-1.6TB-backlog-fanout3-step1.yaml
