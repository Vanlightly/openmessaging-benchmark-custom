...
cat > workloads/benchmark-kafka-withkey-50MBs-400-800parts-step1.yaml << EOF
name: benchmark-kafka-withkey-50MBs-400-800parts-step1__AK-400part
...
cat > workloads/benchmark-kafka-withkey-50MBs-400-800parts-step2.yaml << EOF
name: benchmark-kafka-withkey-50MBs-400-800parts-step2__AK-800part
...
workloads/benchmark-kafka-withkey-50MBs-400-800parts-step1.yaml \
workloads/benchmark-kafka-withkey-50MBs-400-800parts-step2.yaml
