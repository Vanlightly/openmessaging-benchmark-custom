...
cat > workloads/benchmark-backlog-drain-1000MB-2.5TB-backlog-fanout2-step1.yaml << EOF
name: benchmark-backlog-drain-1000MB-2.5TB-backlog-fanout2-step1
...
workloads/benchmark-backlog-drain-1000MB-2.5TB-backlog-fanout2-step1.yaml
