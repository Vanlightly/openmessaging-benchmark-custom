...
cat > workloads/benchmark-backlog-drain-1000MB-5TB-backlog-fanout1-step1.yaml << EOF
name: benchmark-backlog-drain-1000MB-5TB-backlog-fanout1-step1
...
workloads/benchmark-backlog-drain-1000MB-5TB-backlog-fanout1-step1.yaml
