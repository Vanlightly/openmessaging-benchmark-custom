...
public class RedpandaBenchmarkConsumer implements BenchmarkConsumer, OffsetCommitCallback {
    ...
    public RedpandaBenchmarkConsumer(KafkaConsumer<String, byte[]> consumer,
        ...
        log.info("Set offsetCommitLingerMs to " + this.offsetCommitLingerMs);
